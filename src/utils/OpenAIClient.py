...
class OpenAIClient:
    ...
    def prompt(
        ...
        :param system_prompt: The prompt to make the user
        prompt structured in a specific way.
        :param tools: A list of function tools that can
        be given to the client to make it able to answer
        :return: A dictionary {'content': message, 'tools': returned_tools}
         with message being the resulting message of the prompt,
        and returned_tools being the tools that the prompt used
        with their corresponding arguments as a list of dictionaries
        {'tool': tool, 'args': args} with tool being the FunctionTool used,
         and args a dictionary {arg_name: arg_value}
        """
